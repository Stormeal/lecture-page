...
export const PLAYWRIGHT_COURSE: Course = {
  ...
  items: [
...

    {
      id: 'tasks',
      title: 'Exercises',
      summary: 'List of exercises and challenges',
      badge: 'Tasks',
      type: 'content',
      blocks: [
        ...
        {
          type: 'p',
          text: 'This section will contain the exercises we’ll go through during the course. We can also add extra challenges here as you progress.',
        },
      ],
    },
