...
@Component({
  ...
  template: `
    <div class="w-full max-w-3xl">
      <!-- Top "title bar" -->
      <div
        class="rounded-t-xl border border-white/20 bg-[#2f6fd6] px-5 py-3 shadow-[0_20px_60px_rgba(0,0,0,0.35)]"
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-[1.05fr_0.95fr]">
          ...
          <div class="p-6 sm:p-8 bg-gradient-to-b from-[#f5f9ff] to-[#e9f1ff]">
            ...
            <div class="mt-6 text-xs text-gray-500 leading-relaxed">
              ...
              <div>
                On shared computers, use <span class="font-semibold">Logout</span> when you’re done.
                Sessions also expire after inactivity.
              </div>
            </div>
          </div>
...
export class CourseUnlockDialogComponent {
  private dialogRef = inject(DialogRef<boolean>);
  private data = inject<CourseUnlockDialogData>(DIALOG_DATA);
  ...
  slug = computed(() => this.data.slug ?? 'unknown');
